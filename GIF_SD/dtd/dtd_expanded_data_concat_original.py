...
class DTDDataloader(data.Dataset):
    def __init__(self, root, split='1', transform=None, train=True):
...
def main():
    ...
    original_trainset = DTDDataloader(args.data_dir, data_split, transform_train, train=True)
    testset = DTDDataloader(args.data_dir,  data_split, transform_test, train=False)     
    num_classes=47
    args.num_classes=47    
