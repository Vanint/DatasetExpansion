...
def main():
    ...
    if args.dataset == 'caltech101':
        ...
        num_classes = 102
        trainset = datasets.ImageFolder(root=args.data_dir+'/train', transform=transform_train) 
        testset = datasets.ImageFolder(root=args.data_dir+'/test', transform=transform_test)     

    print("{} Mode: Contain {} images".format("Train", len(trainset)))
