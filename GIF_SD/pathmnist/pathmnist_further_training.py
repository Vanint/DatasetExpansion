...
def find_classes(dir, class_names):
...
class Custom_ImageFolder(data.Dataset): 
    def __init__(self, root, loader=default_loader, transform=None, class_names=None):
        classes, class_to_idx = find_classes(root, class_names)
...
def main():
    ...
    original_trainset = Custom_ImageFolder(args.data_dir,  transform=transform_train, class_names=class_names) 
    ...
    print("{} Mode: Contain {} images".format("Train", len(original_trainset)))
    #trainloader = data.DataLoader(new_trainset, batch_size=args.train_batch, shuffle=True, num_workers=args.workers)
    
    class_names = original_trainset.classes
     
    print("new_name:", original_trainset.class_to_idx)
    ...
    train_loader = data.DataLoader(dataset=original_trainset, batch_size=args.train_batch, shuffle=True, num_workers=args.workers) 
