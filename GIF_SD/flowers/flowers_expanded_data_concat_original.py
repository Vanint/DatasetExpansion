...
def main():
    ...
    original_trainset =  datasets.ImageFolder(os.path.join(args.data_dir, 'train'),  transform_train) 
    testset = datasets.ImageFolder(os.path.join(args.data_dir, 'valid'),  transform_test) 
    num_classes=102 
