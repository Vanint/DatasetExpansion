...
class Custom_ImageFolder():
    "Helper class to ensure equal distribution of classes in both train and validation datasets"
    
    def __init__(self, data_dir, num_cl, val_split=0.2, train = True, train_transforms=None, val_transforms=None):
...
def main():
    ...
    num_classes=37      
    original_trainset = Custom_ImageFolder(args.data_dir, num_classes, val_split=0.48, train = True, train_transforms=transform_train) 
    testset = Custom_ImageFolder(args.data_dir, num_classes, val_split=0.48, train = False, val_transforms=transform_test)   
